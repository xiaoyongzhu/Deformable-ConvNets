...
def main():
    ...
    config.symbol = 'resnet_v1_101_fpn_dcn_rcnn' if not args.fpn_only else 'resnet_v1_101_fpn'
    ...
    # arg_params, aux_params = load_param(cur_path + '/../model/' + ('fpn_dcn_xview_480_640_800_alltrain' if not args.fpn_only else 'fpn_coco'), 11, process=True)
    ...
    print("warming up...")
    # # warm up
    # disable warming up to speed up
    # for j in xrange(2):
