...
class coco(IMDB):
    ...
    def gt_roidb(self):
        ...
        if os.path.exists(cache_file):
            ...
            print '{} gt roidb loaded from {}, type is'.format(self.name, cache_file, type(roidb))
            return roidb
    ...
    def _load_coco_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            if obj['iscrowd']:
                ...
                overlaps[ix, cls] = 1.0
        # print(index)
        # print(self.coco.getImgIds(index))
        print(im_ann)
    ...
    def load_coco_sds_annotation(self, index):
        ...
        # print(index)
        # print(self.coco.getImgIds(index))
        sds_rec = {'image': self.image_path_from_index(im_ann['file_name']),
                   'height': height,
                   'width': width,
                   'boxes': boxes,
                   'gt_classes': gt_classes,
